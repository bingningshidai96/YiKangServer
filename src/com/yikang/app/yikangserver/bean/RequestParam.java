...
public class RequestParam {   
	...
	public RequestParam(String appId,String acessTicket,String machineCode,Map<String,Object> paramData){
	...
	/**
	 * 如果之前设置了参数，这个将会调用覆盖之前设置的所有paramData参数
	 * 如果不是必要，请使用{@link #addAll() }方法，那个更加安全 
	 * 
	 * @param paramData
	 */
	...
	public List<NameValuePair> toParams(){
		...
		if(paramData!=null){
			...
			params.add(new BasicNameValuePair(KEY_PARAM_DATA, Encrypt(json, ENCRYPT_KEY)));
		}
		return params;
	}
