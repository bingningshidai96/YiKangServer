...
public class SeniorAccount {
	...
	public String toString() {
		return "SeniorAccount [seniorId=" + seniorId + ", name=" + name
				+ ", sex=" + sex + ", birthday=" + birthday + ", birthYear="
				+ birthYear + ", cardNumber=" + cardNumber + ", cardType="
				+ cardType + ", socialSecurity=" + socialSecurity + ", race="
				+ race + ", faith=" + faith + ", livingConditions="
				+ livingConditions + ", paymentType=" + paymentType
				+ ", incomeSources=" + incomeSources + ", phoneNo=" + phoneNo
				+ ", roomOrientation=" + roomOrientation + ", outWindow="
				+ outWindow + ", createTime=" + createTime + ", updateTime="
				+ updateTime + "]";
	}
