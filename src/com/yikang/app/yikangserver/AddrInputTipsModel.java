 ...
 *
 */
public class AddrInputTipsModel implements InputtipsListener{
	private static final String TAG="AddrInputTipsModel";
	private String keyWord;
	private String cityCode;
	private Inputtips inputTips;
	
	public AddrInputTipsModel (Context context,String cityCode){
	...
	public interface OnTipsResultListener{
		/**
		 * 回调方法，返回搜索结果
		 * @param addrList 地址的List
		 * @param keyWord  addrList对应的搜索关键字
		 * @param isRusultOK 是否是请求成功的结果
		 */
