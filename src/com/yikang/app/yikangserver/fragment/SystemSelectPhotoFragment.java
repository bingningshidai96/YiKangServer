...
public class SystemSelectPhotoFragment extends Fragment implements OnClickListener{
	...
	private void initPopUpWindow(){
		...
		View view = inflater.inflate(R.layout.ppw_register_get_pic, (ViewGroup) getView(),false);
...
//		ColorDrawable drawable = new ColorDrawable(Color.parseColor("#aad9d6d8"));
//		pWindow.setBackgroundDrawable(drawable);
	...
	public void camera() {
		...
		boolean hasSdcard = Environment.MEDIA_MOUNTED
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		if(completeFile == null){
			completeFile = new File(AppContext.CACHE_IMAGE_PATH,PHOTO_FILE_NAME);
		}
		if(requestCode==REQUEST_PIC_PICK&&resultCode == Activity.RESULT_OK){
			...
			crop(originUri,Uri.fromFile(completeFile),300,300);
		}else if(requestCode==REQUEST_PHOTO_CUT&&resultCode==Activity.RESULT_OK){
			if(listener!=null){
