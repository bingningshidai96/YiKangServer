...
public class FreeTimeCalendarActivty extends BaseActivity implements
		OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		intent.putExtra(EditTimeActivity.EXTRA_SERVICE_DATE,
				schedule.serviceDate);
		intent.putExtra(EditTimeActivity.EXTRA_SERVICE_DATE_STR,
