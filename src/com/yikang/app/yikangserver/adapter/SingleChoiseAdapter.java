...
public abstract class SingleChoiseAdapter extends CommonChoiseAdapter<Question> implements OnCheckedChangeListener{
	private static final String TAG = "SigleChoiseAdapter";
	
	/**
	 * 所有选择的答案都会存放到这个map集合中
	 * key：为某个位置
	 * value:为某个 答案的位置
	 */
	...
	public void restoreAnswer(List<Question> questions) {
		for (Question question : questions) {
			...
			if(qPosition==-1){LOG.e(TAG, "服务器返回了不属于这个表的问题");continue;}
