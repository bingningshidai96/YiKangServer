...
public abstract class CommonChoiseAdapter<T> extends CommonAdapter<T>{
	 ...
	 */
	protected int[] buffIds = { R.id.choice_item0, R.id.choice_item1, R.id.choice_item2,
			R.id.choice_item3, R.id.choice_item5, R.id.choice_item6, R.id.choice_item7,
			R.id.choice_item8, R.id.choice_item9, R.id.choice_item10, R.id.choice_item11,
			R.id.choice_item12,R.id.choice_item13,R.id.choice_item14,R.id.choice_item15,
			R.id.choice_item16,R.id.choice_item17,R.id.choice_item18,R.id.choice_item19,
			R.id.choice_item20,R.id.choice_item21,R.id.choice_item22,R.id.choice_item23};
		...
		if (count < answerCounts) {// 不够就增加
			for (int index = count; index < answerCounts; index++) {
				...
				if (answer == null) { // 如果缓存为空，就新创建
					answer = inflater.inflate(
							answerlayId, answerContainer,false);
				}
